...
test("YouTube validation rejects playlists, redirects and unrelated hosts", () => {
  assert.throws(() => normalizeYouTubeUrl("https://youtube.com/playlist?list=abc"), /satu video/);
  assert.throws(() => normalizeYouTubeUrl("https://youtube.com/redirect?q=https://example.com"), /satu video/);
  assert.throws(() => normalizeYouTubeUrl("https://example.com/watch?v=dQw4w9WgXcQ"), /satu video/);
